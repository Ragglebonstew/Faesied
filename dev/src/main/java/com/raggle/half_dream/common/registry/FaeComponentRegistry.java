...
import com.raggle.half_dream.common.component.DreamPlayerComponentImpl;
...
public class FaeComponentRegistry implements ChunkComponentInitializer, EntityComponentInitializer {
	...
	public static final ComponentKey<DreamEntityComponent> DREAM_ENTITY = ComponentRegistryV3.INSTANCE.getOrCreate(new Identifier(Faesied.MOD_ID, "dream_entity"), DreamEntityComponent.class);
	public static final ComponentKey<DreamPlayerComponent> DREAM_PLAYER = ComponentRegistryV3.INSTANCE.getOrCreate(new Identifier(Faesied.MOD_ID, "dream_player"), DreamPlayerComponent.class);
