...
public class FaeParticleRegistry {
	...
	public static void init() {
		Registry.register(Registries.PARTICLE_TYPE, new Identifier(HalfDream.MOD_ID, "mist"), INTERLOPER_MIST);
		Registry.register(Registries.PARTICLE_TYPE, new Identifier(HalfDream.MOD_ID, "fallen_star"), FALLEN_STAR);
	}
}
